...
function Contact() {
    return (
      <>
      <PageHeader url="public/contact.png" header="Contact Us" first="Home" seconed="Contact" />
        <section className=" mb-36 mt-24">
          ...
          >
            ...
            src="public/suslu.webp" alt="" className="md:w-[700px] md:h-[530px] lg:w-[500px] lg:h-[530px] object-cover"/>
            <motion.div
            initial={{ opacity: 0, x: 7 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 2, type: "spring" }}
