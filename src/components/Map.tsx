    ...
    <>
      <section className=" mb-36">
        <div
         ...
         xl:justify-center xl:space-x-24 2xl:space-x-44  xl:flex-row "
        >
          <motion.div
           initial={{ opacity: 0, x: -7 }}
           whileInView={{ opacity: 1, x: 0 }}
           transition={{ duration: 2, type: "spring" }}
          className="w-[100%] h-[400px] sm:w-[450px] md:w-[500px] md:h-[500px] lg:w-[700px] lg:h-[500px]">
            <iframe
          ...
          className=" flex flex-col space-y-6 pb-4">
            ...
            <h1 className=" uppercase text-[42px]  max-w-[410px] leading-[50px] tracking-wide">
              need cake? get in touch with us
            </h1>
