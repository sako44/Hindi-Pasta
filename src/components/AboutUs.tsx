      ...
      <section>
        ...
        before:right-[-30%] after:left-[-30%] md:before:right-[-50%] md:after:left-[-50%] lg:before:right-[-70%] lg:after:left-[-70%] xl:before:right-[-50%] xl:after:left-[-50%]"
            ...
            <h1 className="text-center text-4xl lg:text-5xl leading-[55px] w-[80%] lg:w-[60%] xl:w-[50%] mx-auto mt-5 footer-font uppercase tracking-wider">
              We Create Incredibly Tasty Cakes
            </h1>
          </motion.p>
          <p className="flex flex-col  max-lg:space-y-12 lg:flex-row lg:space-x-28 footer-font mx-auto">
            ...
            >
              <span className="text-2xl text-primary">"Hindi"</span> was
              established in 2018 with a passion for delivering high-quality
              cakes, ice creams, and a variety of sweets. From the very
              beginning, we've been dedicated to crafting delicious and
            ...
            <motion.p
              ...
              transition={{ duration: 2, type: "spring" }}
            >
              <span className="text-2xl text-primary">Whether</span> it's our
              creamy, fruit-infused ice creams or our diverse range of cakes,
              every product at Hindi reflects our commitment to quality and
              taste. We continually strive to bring new flavors and experiences
              to our customers, ensuring every visit to Hindi is memorable,,
              catering to all taste preferences. Our team of talented bakers and
              chefs work
            </motion.p>
          </p>
          <motion.img
            ...
            src="/about-cake.jpg"
            alt=""
            className="object-right  w-[90%] mx-auto h-[350px] object-cover"
          />
        </head>
      </section>
      <ScrollBar />
